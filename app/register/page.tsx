          ...
          <div>
            ...
            <div className="mt-24 max-w-lg">
              ...
              <h1 className="mt-6 text-5xl font-semibold leading-tight tracking-tight">
                Build a focused plan for
                <span className="text-zinc-500"> every interview.</span>
              </h1>

              <p className="mt-5 max-w-md text-base leading-7 text-zinc-500">
                Create personalised prep kits from real job descriptions and
                company research, then practice with targeted questions and
                confidence-based flashcards.
              </p>

              <div className="mt-10 space-y-4">
                {[
                  "Extract role requirements automatically",
                  "Research the company and hiring context",
                  "Generate targeted interview questions",
                  "Practice and track your confidence",
                ].map((feature) => (
          ...
          <div className="w-full max-w-md">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-500">
                Start building personalised interview kits and keep your
                progress saved in one place.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                ...
                <div className="mt-2 flex items-center gap-2">
                  <span
                    className={`h-1.5 w-1.5 rounded-full ${
                      password.length >= 8 ? "bg-emerald-400" : "bg-zinc-700"
                    }`}
                  />
              ...
              <button
                ...
                className="group flex w-full items-center justify-center gap-2 rounded-xl bg-white px-5 py-3.5 text-sm font-semibold text-black transition hover:bg-zinc-200 active:scale-[0.995] disabled:cursor-not-allowed disabled:opacity-50"
              >
                {loading ? (
                  <>
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <span className="text-xs text-zinc-700">Already registered?</span>
              <div className="h-px flex-1 bg-zinc-900" />
            </div>
            ...
            <p className="mt-6 text-center text-xs leading-5 text-zinc-700">
              Your account keeps your generated kits, edits and practice
